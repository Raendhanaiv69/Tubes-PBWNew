...
<body>
  <div class="bg-gray-100 flex flex-row-reverse justify-center items-center h-screen">
    ...
    <div class="lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-1/2 max-h-screen">
      <h1 class="text-3xl font-bold mb-4 text-bll text-center">Daftar Sebagai Admin</h1>
      ...
      <form action="{{ route('registerAdmin') }}" method="POST">
        ...
        <div class="mb-4">
          ...
          <input type="text" id="username" name="username" value="{{ old('username') }}" class="w-full border border-gray-300 rounded-full py-2 px-3 focus:outline-none focus:border-blue-500" autocomplete="off">
        </div>
        {{-- Email --}}
        <div class="mb-4">
