...
<body>
  <div class="bg-gray-100 flex justify-center items-center h-screen">
    <div class="relative p-10 justify-center w-1/2 h-screen lg:flex flex-col hidden bg-bk gap-5">
      <div class="text-6xl text-txt font-extrabold font-ultra mb-10 pb-10">Welcome Back!</div>
    ...
    <div class="lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-1/2">
      <h1 class="text-3xl font-bold mb-4 text-bll text-center">Login</h1>
      <form action="{{ route('login') }}" method="POST">
        @csrf
        <!-- Username Input -->
        <div class="mb-4">
          <label for="name" class="block text-gray-600">Username</label>
          <input type="text" id="name" name="name" class="w-full border border-gray-300 rounded-full py-2 px-3 focus:outline-none focus:border-blue-500" autocomplete="off">
        </div>
        <!-- Password Input -->
        <div class="mb-4">
